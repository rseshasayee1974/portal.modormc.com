...
<body>
            ...
            <table>
                <tr>
                    <td style="text-align: left; padding: 4px 8px;">
                        <span style="font-weight: bold; color: #1e293b;">Dispatch Token</span>
                    </td>
                    <td style="text-align: right; padding: 4px 8px;">
                        <button onclick="window.print()" class="primary" style="padding: 4px 8px;">Print Token</button>
                        <a href="{{ route('batches.dispatch-token.download', $batch->encrypted_id ?? $batch->id) }}" style="padding: 4px 8px; margin-left: 4px;">Download PDF</a>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <table class="meta-table">
        ...
        <tr>
            <td class="meta-label">Loaded Wt:</td>
            <td class="meta-value font-mono">{{ $loadedWeightStr }}</td>
        </tr>
         <tr style="font-weight: bold;">
            <td class="meta-label" style="font-size: 11px;">Net Weight:</td>
            <td class="meta-value font-mono" style="font-size: 12px; font-weight: bold;">{{ $netWeightStr }}</td>
        </tr>
         <tr>
        ...
        <tr>
            <td class="meta-label">Loaded Time:</td>
            <td class="meta-value font-mono">
    ...
    <div class="footer">
        ...
        <div style="margin-top: 4px; font-weight: bold;">Safe Journey!</div>
    </div>
</body>
