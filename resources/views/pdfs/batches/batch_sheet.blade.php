...
<head>
    ...
    <style>
        ...
        .materials .group-head th {
            font-weight: 700;
            font-size: 11px;
            background: #f7f7f7;
        }

        .materials .name-row th {
            font-size: 9px;
            font-weight: 700;
            height: 18px;
        }

        .materials .number-row td {
            font-size: 11px;
            font-weight: 700;
        }
...
<body>
    ...
    <div class="sheet">
        ...
        <table class="info-grid">
            ...
            <tr>
                <td class="k">Batch Start Time</td>
                <td class="v">: {{ optional($batch->start_time)->format('H:i:s') ?? '-' }}</td>
            ...
            <tr>
                ...
                <td class="v">: {{ optional($batch->end_time)->format('H:i:s') ?? '-' }}</td>
                <td class="k">Truck Driver</td>
                <td class="v">:
            ...
            <tr>
                ...
                <td class="v">: {{ number_format((float) $batch->batch_size, 2) }}</td>
            </tr>
        </table>
