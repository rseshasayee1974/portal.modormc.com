    ...
    <div class="inv-root">
        ...
        <div class="inv-header">
            ...
            <div class="header-right">
                ...
                <div class="inv-ref">Ref# <strong>{{ strtoupper($data['doc_no']) }}</strong></div>
            </div>
        </div>
                    ...
                    <table class="kv-table">
                        @php
                            ...
                            if (
                                ...
                                $kv1['EWayBillNo'] = $data['meta']['eway_bill_no'];
                            }
                            if (!empty($data['meta']['sales_executive_name'])) {
                                $kv1['Sales Exec'] = $data['meta']['sales_executive_name'];
                            }
                        @endphp
                        @foreach ($kv1 as $k => $v)
                            @if ($v)
                    ...
                    <table class="kv-table">
                        ...
                        @else
                            @if ($data['meta']['project_name'] ?? false)
                                <tr>
                                    <td class="kv-key">Project</td>
                                    <td class="kv-sep">:</td>
                                    <td class="kv-val bold">{{ $data['meta']['project_name'] }}</td>
                                </tr>
                            @endif
                            <tr>
                                <td class="kv-key">Status</td>
                                <td class="kv-sep">:</td>
                                <td class="kv-val bold">{{ $data['state'] }}</td>
                            </tr>
                        @endif
                    </table>
                </td>
        ...
        <table class="addr-table">
            <thead>
                <tr>
                    <th class="addr-th addr-th-left">
                        {{ $labels['bill_to'] ?? ($data['doc_title'] === 'PURCHASE ORDER' ? 'Vendor Details' : 'Bill To') }}
                    </th>
                    <th class="addr-th">
                        {{ $labels['ship_to'] ?? ($data['doc_title'] === 'PURCHASE ORDER' ? 'Delivery Address' : 'Ship To') }}
                    </th>
                </tr>
            </thead>
            <tbody>
                    ...
                    <tr>
                        <td style="width: 50%; vertical-align: bottom; border: none; text-align: left; padding: 0;">
                            @if (($pdfSettings['show_bank_details'] ?? true) && !empty($data['company']['bank']['bank_name']))
                                <div style="margin-bottom: 8px; font-size: 9.5px; color: #334155;">
                                    ...
                                    <div>Account Name: <strong>{{ $data['company']['bank']['account_name'] }}</strong>
                                    </div>
                                    <div>Account Number:
                                        <strong>{{ $data['company']['bank']['account_number'] }}</strong></div>
                        ...
                        <td style="width: 50%; vertical-align: bottom; border: none; text-align: right; padding: 0;">
                            <div
                                ...
                                @endif
                                <span
                                    style="display:inline-block;width:160px;border-top:1px solid #999;padding-top:4px;text-align:center;font-size:10.5px;color:#64748b">
                                    Authorized Signatory<br><span style="font-size:9px">For
