...
<head>
    ...
    <style>
        {!! $css ?? $report_css ?? (file_exists(public_path('css/reports/site_consolidated_report.css')) ? file_get_contents(public_path('css/reports/site_consolidated_report.css')) : (file_exists(public_path('css/reports/report_pdf.css')) ? file_get_contents(public_path('css/reports/report_pdf.css')) : '')) !!}
    </style>
</head>
<body>
