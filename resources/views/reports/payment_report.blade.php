        ...
        <tr>
            <td style="width: 52%;">
                <div class="address-box" style="margin-top: 5px;">
                    ...
                    <span class="address-name">{{ $target_name ?? 'All Payment Vouchers' }}</span>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th style="width: 22%;">Paid To (Party)</th>
                <th style="width: 18%;">Paid From (Account)</th>
        ...
        <tbody>
            ...
            @forelse($rows as $idx => $trx)
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        <span class="badge-dr" style="font-size: 7.5pt;">{{ $trx['status'] ?? 'Paid' }}</span>
                    </td>
            ...
            @empty
                <tr>
                    <td colspan="8" class="text-center" style="padding: 15px; color: #94a3b8; font-style: italic;">No payment vouchers recorded for this period.</td>
                </tr>
            @endforelse
            ...
            <tr class="closing-row">
                <td colspan="7" class="text-right font-bold" style="padding: 10px 14px; text-transform: uppercase; font-size: 8.5pt; color: #cbd5e1;">
                    Total Payments ({{ count($rows) }} Vouchers)
                </td>
