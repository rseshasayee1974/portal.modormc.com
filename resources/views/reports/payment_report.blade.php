...
<head>
    ...
    <style>
        ...
        .header { text-align: center; margin-bottom: 30px; border-bottom: 4px solid #ef4444; padding-bottom: 10px; }
        .header h1 { font-size: 24pt; margin: 0; color: #ef4444; text-transform: uppercase; letter-spacing: 3px; }
        ...
        table.data-table th { background-color: #fef2f2; border-bottom: 2px solid #ef4444; padding: 12px 10px; text-align: left; font-size: 8pt; text-transform: uppercase; color: #991b1b; }
        table.data-table td { padding: 10px; border-bottom: 1px solid #fee2e2; font-size: 9pt; }
    ...
    <table class="data-table">
        ...
        <tfoot>
            <tr style="background-color: #fef2f2;">
                <td colspan="3" class="text-right font-bold" style="padding: 12px;">TOTAL PAYMENTS:</td>
