...
const enableTwoFactorAuthentication = () => {
    ...
    router.post(route('twofactor.enable'), {}, {
        preserveScroll: true,
...
const showQrCode = () => {
    return axios.get(route('twofactor.qrcode')).then(response => {
        qrCode.value = response.data.svg;
    });
};

const showSetupKey = () => {
    return axios.get(route('twofactor.secretkey')).then(response => {
        setupKey.value = response.data.secretKey;
    });
}

const showRecoveryCodes = () => {
    return axios.get(route('twofactor.recoverycodes')).then(response => {
        recoveryCodes.value = response.data;
    });
};

const confirmTwoFactorAuthentication = () => {
    confirmationForm.post(route('twofactor.confirm'), {
...
const regenerateRecoveryCodes = () => {
    axios
        .post(route('twofactor.recoverycodes'))
...
const disableTwoFactorAuthentication = () => {
    ...
    router.delete(route('twofactor.disable'), {
        preserveScroll: true,
        onSuccess: () => {
            ...
            <div class="mt-5">
                <div v-if="! twoFactorEnabled">
                    <ConfirmsPassword @confirmed="enableTwoFactorAuthentication">
                        <PrimaryButton type="button" :class="{ 'opacity25': enabling }" :disabled="enabling">
                            Enable
                        </PrimaryButton>
                    </ConfirmsPassword>
                </div>
                ...
                <div v-else>
                    <ConfirmsPassword @confirmed="confirmTwoFactorAuthentication">
                        <PrimaryButton
                            ...
                            type="button"
                            class="me-3"
                            :class="{ 'opacity25': enabling || confirmationForm.processing }"
