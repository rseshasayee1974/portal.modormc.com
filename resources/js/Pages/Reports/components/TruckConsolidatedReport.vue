            ...
            <div class="px-5 py-4 border-b border-slate-100 bg-slate-50/70 flex flex-col md:flex-row md:items-center justify-between gap-3">
                ...
                <!-- <div class="flex flex-wrap items-center gap-2">
                    <select 
                        ...
                        class="border border-slate-200 rounded px-2.5 py-1.5 text-xs text-slate-700 bg-white font-semibold focus:outline-none focus:ring-1 focus:ring-[#0064d2]"
                    >
                        <option value="">All Trucks ({{ truckOptions.length }})</option>
                        <option v-for="t in truckOptions" :key="t" :value="t">{{ t }}</option>
                    </select>
