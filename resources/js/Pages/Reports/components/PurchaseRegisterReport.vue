...
<template>
    <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
            ...
            <div class="border border-slate-200 rounded p-4 bg-[#fce4d6] border-[#f8cbad] flex justify-between items-center">
                <div>
            ...
            <table class="w-full text-left border-collapse min-w-[1000px]">
                <thead>
                    <tr class="text-[10px] font-bold uppercase tracking-wider text-slate-600 border-b border-slate-200 bg-[#f2f4f7]">
                        ...
                        <th class="py-3 px-4" width="16%">Supplier Name</th>
                        <th class="py-3 px-4 text-center" width="9%">GSTIN</th>
                        <th class="py-3 px-4" width="12%">Product</th>
                        <th class="py-3 px-4 text-right" width="6%">Qty</th>
                        <!-- <th class="py-3 px-4 text-right" width="6%">Rate</th> -->
                        <th class="py-3 px-4 text-right" width="9%">Taxable Amt</th>
                        ...
                        <th class="py-3 px-4 text-right" width="9%">Net Amt</th>
                    </tr>
                </thead>
