...
<template>
    <div class="space-y-6">
        ...
        <PatronStatementView v-if="isSinglePatron" :report-data="reportData" @back="emit('clear-patron')" />
        ...
        <template v-else>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div
                    class="bg-gradient-to-br from-rose-50 via-white to-white p-4 rounded-xl border border-rose-200 shadow-xs flex flex-col justify-between">
                    <div class="flex items-center justify-between">
                        <span class="text-[11px] font-bold uppercase tracking-wider text-rose-700">Total
                            Outstanding</span>
                    ...
                    <div class="mt-2">
                        <div class="text-md font-black text-rose-800 tracking-tight">
                            {{ formatCurrency(summary.totalOutstanding) }}
                        </div>
                        <p class="text-[11px] text-rose-600 font-medium mt-0.5">
                            {{ summary.customersWithBalance }} of {{ summary.totalCustomers }} customers with open
                            balance
                        </p>
                    </div>
                </div>
                ...
                <div
                    class="bg-white p-4 rounded-xl border border-slate-200 shadow-xs flex flex-col justify-between hover:border-slate-300 transition-colors">
                    <div class="flex items-center justify-between">
                        <span class="text-[11px] font-bold uppercase tracking-wider text-slate-500">Total
                            Invoiced</span>
                    ...
                    <div class="mt-2">
                        <div class="text-md font-black text-[#1d2d3e] tracking-tight">
                ...
                <div
                    class="bg-white p-4 rounded-xl border border-slate-200 shadow-xs flex flex-col justify-between hover:border-slate-300 transition-colors">
                    <div class="flex items-center justify-between">
                        <span class="text-[11px] font-bold uppercase tracking-wider text-emerald-700">Total
                            Receipts</span>
                    ...
                    <div class="mt-2">
                        <div class="text-md font-black text-emerald-700 tracking-tight">
                ...
                <div
                    class="bg-white p-4 rounded-xl border border-slate-200 shadow-xs flex flex-col justify-between hover:border-slate-300 transition-colors">
                    <div class="flex items-center justify-between">
                        <span class="text-[11px] font-bold uppercase tracking-wider text-indigo-700">Total
                            Payments</span>
                    ...
                    <div class="mt-2">
                        <div class="text-md font-black text-indigo-800 tracking-tight">
            ...
            <div class="bg-white rounded-xl border border-slate-200 p-4 shadow-xs">
                <div class="flex items-center justify-between mb-3">
                    <div class="flex items-center gap-2">
                        <h4 class="text-xs font-bold uppercase tracking-wider text-slate-700">Accounts Receivable Aging
                            Breakdown</h4>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    <div class="bg-blue-50/60 border border-blue-200/80 rounded-lg p-3">
                        <div class="flex items-center justify-between">
                            <span class="text-[10px] font-bold uppercase text-blue-700 tracking-wider">0 - 30
                                Days</span>
                            <span
                                class="text-[9px] px-1.5 py-0.5 rounded bg-blue-100 text-blue-800 font-semibold">Current</span>
                        </div>
                    ...
                    <div class="bg-amber-50/60 border border-amber-200/80 rounded-lg p-3">
                        <div class="flex items-center justify-between">
                            <span class="text-[10px] font-bold uppercase text-amber-700 tracking-wider">31 - 60
                                Days</span>
                            <span
                                class="text-[9px] px-1.5 py-0.5 rounded bg-amber-100 text-amber-800 font-semibold">Overdue</span>
                        </div>
                    ...
                    <div class="bg-orange-50/60 border border-orange-200/80 rounded-lg p-3">
                        <div class="flex items-center justify-between">
                            <span class="text-[10px] font-bold uppercase text-orange-700 tracking-wider">61 - 90
                                Days</span>
                            <span
                                class="text-[9px] px-1.5 py-0.5 rounded bg-orange-100 text-orange-800 font-semibold">Attention</span>
                        </div>
                    ...
                    <div class="bg-rose-50/70 border border-rose-200 rounded-lg p-3">
                        <div class="flex items-center justify-between">
                            ...
                            <span
                                class="text-[9px] px-1.5 py-0.5 rounded bg-rose-200 text-rose-900 font-bold">Critical</span>
                        </div>
            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-xs">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p class="text-[11px] text-slate-400 font-medium">
                                Showing {{ filteredCustomers.length }} customer account{{ filteredCustomers.length === 1
                                    ? '' : 's' }}
                            </p>
                        </div>
                    </div>
                ...
                <div class="overflow-x-auto max-h-[600px] overflow-y-auto">
                    <table class="w-full text-left border-collapse min-w-[980px]">
                        ...
                        <tbody class="text-xs divide-y divide-slate-100">
                            <tr v-for="(c, cIdx) in paginatedCustomers" :key="c.customer_id"
                                ...
                                <td class="py-3 px-3 text-center">
                                    <button type="button" @click="emit('select-patron', c.customer_id)"
                        ...
                        <tfoot v-if="filteredCustomers.length > 0"
                            class="sticky bottom-0 bg-slate-100 font-bold text-xs border-t-2 border-slate-300 shadow-2xs z-10">
                            <tr>
                ...
                <div v-if="totalCount > perPage || totalPages > 1"
                    ...
                    <div class="flex items-center gap-1">
                        ...
                        <button type="button" @click="goToPage(sanitizedPage + 1)"
