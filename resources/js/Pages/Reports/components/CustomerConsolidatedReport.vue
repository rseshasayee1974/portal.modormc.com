    ...
    <div v-if="reportData" class="space-y-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
            ...
            <div class="bg-white p-3 rounded border border-slate-200 shadow-sm">
                ...
                <p class="text-sm font-bold text-slate-600 mt-1">{{ formatQuantity(reportData.total_truck_empty) }} T</p>
            </div>
            <div class="bg-white p-3 rounded border border-slate-200 shadow-sm">
                <span class="text-[9px] font-black uppercase text-slate-400">Loaded Wt</span>
                <p class="text-sm font-bold text-slate-600 mt-1">{{ formatQuantity(reportData.total_loaded_weight) }} T</p>
            </div>
            <div class="bg-white p-3 rounded border border-slate-200 shadow-sm">
                ...
                <table class="w-full text-left border-collapse min-w-[1200px]">
                    <thead>
                        <tr class="text-[10px] font-bold uppercase tracking-wider text-slate-600 border-b border-slate-200 bg-[#f8fafc]">
                            ...
                            <th class="py-3 px-3" width="12%">Docket / DSP #</th>
