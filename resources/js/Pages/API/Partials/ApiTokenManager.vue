...
const createApiToken = () => {
    createApiTokenForm.post(route('apitokens.store'), {
        preserveScroll: true,
        onSuccess: () => {
...
const updateApiToken = () => {
    updateApiTokenForm.put(route('apitokens.update', managingPermissionsFor.value), {
        preserveScroll: true,
        preserveState: true,
...
const deleteApiToken = () => {
    deleteApiTokenForm.delete(route('apitokens.destroy', apiTokenBeingDeleted.value), {
        preserveScroll: true,
        preserveState: true,
    ...
    <div>
        ...
        <FormSection @submitted="createApiToken">
            ...
            <template #actions>
                ...
                <PrimaryButton :class="{ 'opacity25': createApiTokenForm.processing }" :disabled="createApiTokenForm.processing">
                    Create
                </PrimaryButton>
            </template>
        </FormSection>
        ...
        <DialogModal :show="managingPermissionsFor != null" @close="managingPermissionsFor = null">
            ...
            <template #footer>
                ...
                <PrimaryButton
                    class="ms-3"
                    :class="{ 'opacity25': updateApiTokenForm.processing }"
        ...
        <ConfirmationModal :show="apiTokenBeingDeleted != null" @close="apiTokenBeingDeleted = null">
            ...
            <template #footer>
                ...
                <DangerButton
                    class="ms-3"
                    :class="{ 'opacity25': deleteApiTokenForm.processing }"
