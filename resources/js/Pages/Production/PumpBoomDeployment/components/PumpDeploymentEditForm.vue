        ...
        <div class="flex items-center justify-between border-b border-slate-100 px-5 py-4 dark:border-slate-800">
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-sm font-bold text-slate-800 dark:text-slate-100">
                    Edit Pump Deployment #{{ deployment?.id }}
                </h2>
            </div>
        ...
        <form @submit.prevent="submitForm" class="space-y-6 p-5">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between gap-3 pt-2">
                ...
                <div class="flex items-center justify-end gap-2 shrink-0 sm:self-end">
                    <BaseButton label="Cancel Edit" severity="secondary" variant="outlined" @click="emit('cancel')" />
                    <BaseButton label="Save Changes" severity="primary" variant="filled" type="submit" :loading="saving"
