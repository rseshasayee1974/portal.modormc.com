    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            try {
                ...
                toast.add({ severity: 'success', summary: 'Deleted', detail: 'Entity type removed', life: 1500 });
            } catch (error) {
    ...
    <AppLayout title="Entity Types">
        ...
        <div class="p-6">
            <div class="card bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700 rounded-lg">
                <DataTable :value="store.entityTypes" stripedRows class="p-datatable-sm text-sm" :paginator="true" :rows="30">
                    <template #header>
