        ...
        >
            ...
            <Column header="Vehicle" sortable field="machine.registration">
                <template #body="slotProps">
                    <span class="font-mono text-xs font-bold text-slate-700 dark:text-slate-200 bg-slate-100 dark:bg-slate-800/80 px-2 py-1 rounded-md">
            ...
            <!-- Operator -->
            <Column header="Operator" sortable field="operator.username">
                <template #body="slotProps">
                ...
                <template #body="slotProps">
                    <div class="flex flex-col font-mono text-xs">
                        ...
                        <span class="text-[10px] text-slate-400">
                            ₹{{ Number(slotProps.data.amount || 0).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}
                        </span>
                    </div>
                </template>
            </Column>
            ...
            <template #expansion="slotProps">
                <MachineTrackerEditForm
                    :tracker="slotProps.data"
                    :form="editForm"
                    :machineOptions="machineOptions"
                    :shiftOptions="shiftOptions"
                    :operatorOptions="operatorOptions"
                    :errors="errors || editForm.errors"
                    :processing="processing || editForm.processing"
            ...
            <template #empty>
                <div class="py-16 flex flex-col items-center gap-3">
                    <div class="w-14 h-14 rounded-2xl bg-slate-50 dark:bg-slate-800/60 flex items-center justify-center text-slate-400">
