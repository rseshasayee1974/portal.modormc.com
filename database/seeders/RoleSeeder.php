...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $roles = [
            ...
            'QUALITY_MANAGER'     => ['level' => 68,  'description' => 'Quality control manager & lab supervisor'],
            ...
            'LAB_TECHNICIAN'      => ['level' => 32,  'description' => 'Performs laboratory testing & quality logging'],
