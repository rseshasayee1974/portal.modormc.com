...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        $menus = [
            ...
            ['id' => 43,  'menutype' => 2, 'title' => 'Machine Fleet',   'alias' => 'machines',        'link' => 'fleet/machines',         'icon' => 'TruckIcon',            'published' => 1, 'parent_id' => 4,   'level' => 1, 'ordering' => 2,  'permission_name' => 'MACHINE.VIEW'],
            ['id' => 61,  'menutype' => 2, 'title' => 'Machine Type',    'alias' => 'machinetypes',    'link' => 'fleet/machinetypes',     'icon' => 'CogIcon',              'published' => 1, 'parent_id' => 4,   'level' => 1, 'ordering' => 3,  'permission_name' => 'MACHINE_TYPE.VIEW'],
            ['id' => 65,  'menutype' => 2, 'title' => 'Drivers',         'alias' => 'drivers',         'link' => 'fleet/drivers',          'icon' => 'IdentificationIcon',   'published' => 1, 'parent_id' => 4,   'level' => 1, 'ordering' => 4,  'permission_name' => 'DRIVER.VIEW'],
            ['id' => 66,  'menutype' => 2, 'title' => 'Fuel Logs',       'alias' => 'fuel-logs',       'link' => 'fleet/fuel-logs',        'icon' => 'SwatchIcon',           'published' => 1, 'parent_id' => 4,   'level' => 1, 'ordering' => 5,  'permission_name' => 'FUEL_LOG.VIEW'],
            ['id' => 107, 'menutype' => 2, 'title' => 'Machine Services','alias' => 'machine-services','link' => 'fleet/machine-services', 'icon' => 'WrenchScrewdriverIcon', 'published' => 1, 'parent_id' => 4,  'level' => 1, 'ordering' => 6,  'permission_name' => 'MACHINE_SERVICE.VIEW'],
            ['id' => 108, 'menutype' => 2, 'title' => 'Maintenance',      'alias' => 'maintenance',      'link' => 'fleet/maintenance-requests', 'icon' => 'WrenchIcon',           'published' => 1, 'parent_id' => 4,   'level' => 1, 'ordering' => 7,  'permission_name' => 'MAINTENANCE_REQUEST.VIEW'],
            ['id' => 109, 'menutype' => 2, 'title' => 'Stock Exhausts',  'alias' => 'stock-exhausts',   'link' => 'inventorystock-exhausts',       'icon' => 'ArrowTrendingDownIcon', 'published' => 1, 'parent_id' => 4,   'level' => 1, 'ordering' => 8,  'permission_name' => 'STOCK_EXHAUST.VIEW'],

            // Sidebar: GPS Tracking (parent_id = 102)
            ['id' => 102, 'menutype' => 1, 'title' => 'GPS Tracking',    'alias' => 'gps-tracking',    'link' => 'fleet/gps/live',         'icon' => 'MapIcon',              'published' => 1, 'parent_id' => 0,   'level' => 0, 'ordering' => 5,  'permission_name' => 'GPS_DEVICE.VIEW'],
            ['id' => 103, 'menutype' => 2, 'title' => 'GPS Devices',     'alias' => 'gps-devices',     'link' => 'fleet/gps-devices',      'icon' => 'SignalIcon',           'published' => 1, 'parent_id' => 102, 'level' => 1, 'ordering' => 1,  'permission_name' => 'GPS_DEVICE.VIEW'],
            ['id' => 104, 'menutype' => 2, 'title' => 'Geofences',       'alias' => 'geofences',       'link' => 'fleet/geofences',        'icon' => 'MapPinIcon',           'published' => 1, 'parent_id' => 102, 'level' => 1, 'ordering' => 2,  'permission_name' => 'GEOFENCE.VIEW'],
            ['id' => 105, 'menutype' => 2, 'title' => 'Live Tracking',   'alias' => 'gps-live',        'link' => 'fleet/gps/live',         'icon' => 'RssIcon',              'published' => 1, 'parent_id' => 102, 'level' => 1, 'ordering' => 3,  'permission_name' => 'GPS_DEVICE.VIEW'],
            ['id' => 106, 'menutype' => 2, 'title' => 'Playback',        'alias' => 'gps-playback',    'link' => 'fleet/gps/playback',     'icon' => 'PlayCircleIcon',       'published' => 1, 'parent_id' => 102, 'level' => 1, 'ordering' => 4,  'permission_name' => 'GPS_DEVICE.VIEW'],
