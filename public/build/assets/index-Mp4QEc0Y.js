import{B as X,o as r,d,r as p,A as o,c as y,J as L,h,t as O,ah as x,a4 as oe,aP as re,_ as ae,a_ as B,aC as G,a$ as de,Y as ce,C as ue,I as pe,D as he,E as fe,G as U,S as me,X as V,az as be,aA as ge,b1 as ye,aE as T,H as S,$ as ve,a as v,F as M,f as A,g as q,b as K,w as k,n as w,T as Oe,a6 as Ie,a9 as Se,Q as ke}from"./app-B1Xz-Nfc.js";import{s as we}from"./index-DIXrXJQA.js";import{b as Ce,c as Le,d as Fe,e as xe,a as Ve}from"./index-CPvxXCJt.js";import{a as Ke,f as E,b as Te,R as Me}from"./index-vVErtHBV.js";import{s as De,a as Ae}from"./index-qw1XeJws.js";import{s as Ee}from"./index-DGf5z6Sr.js";import{s as Pe}from"./index-uEfbXvIL.js";import{s as ze,a as Re}from"./index-CYgV8cy1.js";import{O as He}from"./index-BM34T2Pv.js";var Be=`
    .p-chip {
        display: inline-flex;
        align-items: center;
...
`,Ge={root:"p-chip p-component",image:"p-chip-image",icon:"p-chip-icon",label:"p-chip-label",removeIcon:"p-chip-remove-icon"},$e=X.extend({name:"chip",style:Be,classes:Ge}),Ne={name:"BaseChip",extends:Ke,props:{label:{type:[String,Number],default:null},icon:{type:String,default:null},image:{type:String,default:null},removable:{type:Boolean,default:!1},removeIcon:{type:String,default:void 0}},style:$e,provide:function(){return{$pcChip:this,$parentInstance:this}}},Z={name:"Chip",extends:Ne,inheritAttrs:!1,emits:["remove"],data:function(){return{visible:!0}},methods:{onKeydown:function(e){(e.key==="Enter"||e.key==="Backspace")&&this.close(e)},close:function(e){this.visible=!1,this.$emit("remove",e)}},computed:{dataP:function(){return E({removable:this.removable})}},components:{TimesCircleIcon:Pe}},Ue=["aria-label","data-p"],je=["src"];function qe(t,e,i,l,s,n){return s.visible?(r(),d("div",o({key:0,class:t.cx("root"),"aria-label":t.label},t.ptmi("root"),{"data-p":n.dataP}),[p(t.$slots,"default",{},function(){return[t.image?(r(),d("img",o({key:0,src:t.image},t.ptm("image"),{class:t.cx("image")}),null,16,je)):t.$slots.icon?(r(),y(L(t.$slots.icon),o({key:1,class:t.cx("icon")},t.ptm("icon")),null,16,["class"])):t.icon?(r(),d("span",o({key:2,class:[t.cx("icon"),t.icon]},t.ptm("icon")),null,16)):h("",!0),t.label!==null?(r(),d("div",o({key:3,class:t.cx("label")},t.ptm("label")),O(t.label),17)):h("",!0)]}),t.removable?p(t.$slots,"removeicon",{key:0,removeCallback:n.close,keydownCallback:n.onKeydown},function(){return[(r(),y(L(t.removeIcon?"span":"TimesCircleIcon"),o({class:[t.cx("removeIcon"),t.removeIcon],onClick:n.close,onKeydown:n.onKeydown},t.ptm("removeIcon")),null,16,["class","onClick","onKeydown"]))]}):h("",!0)],16,Ue)):h("",!0)}Z.render=qe;var We=`
    .p-multiselect {
        display: inline-flex;
        cursor: pointer;
        position: relative;
