...
class MixDesignTest extends TestCase
{
    ...
    public function test_mix_design_can_be_stored_without_design_type(): void
    {
        $response = $this->actingAs($this->user)->post('/inventory/mixdesigns', [
            'partner_id' => $this->patron->id,
            'design_name' => 'Custom Mix No Type',
            'design_code' => 'M3-CODE',
            'design_type' => null,
            'unit_id' => $this->unit->id,
            'rate_per_qty' => 1500,
    ...
    public function test_mix_design_can_be_updated_without_design_type(): void
    {
        $mixDesign = MixDesign::factory()->create([
            'plant_id' => $this->plant->id,
            'partner_id' => $this->patron->id,
        ...
        $response = $this->actingAs($this->user)->put("/inventory/mixdesigns/{$mixDesign->id}", [
            'partner_id' => $this->patron->id,
            'design_name' => 'Updated Mix No Type',
            'design_code' => 'M2-CODE',
            'design_type' => null,
            'unit_id' => $this->unit->id,
            'rate_per_qty' => 2000,
