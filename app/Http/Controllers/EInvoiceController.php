...
class EInvoiceController extends Controller
{
    ...
    public function testPage(Request $request)
    {
        ...
        $defaultCredentials = [
            ...
            'eway_client_id'     => $config['sandbox_eway_client_id'] ?? 'PEWAYS472417d4a8bc74b10d31d4219c6b343c',
            'eway_client_secret' => $config['sandbox_eway_client_secret'] ?? 'PEWAYS5376280bd5bc93b6c6ddf334a88d7a45',
