...
class StorePlantRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'logo' => ['nullable', 'file', 'mimes:jpeg,png,jpg,webp,svg,gif,bmp,jfif', 'max:10240'],
            'seal_sign' => ['nullable', 'file', 'mimes:jpeg,png,jpg,webp,svg,gif,bmp,jfif', 'max:10240'],
            'upi_qr' => ['nullable', 'file', 'mimes:jpeg,png,jpg,webp,svg,gif,bmp,jfif', 'max:10240'],
            ...
            'address.address_type_id' => ['required_with:address.line_1', 'nullable', 'exists:mm_address_types,id'],
            'address.line_1' => ['nullable', 'string', 'max:255'],
            'address.line_2' => ['nullable', 'string', 'max:255'],
            'address.city' => ['required_with:address.line_1', 'nullable', 'string', 'max:255'],
            'address.state_id' => ['required_with:address.line_1', 'nullable', 'exists:mm_state_codes,id'],
            'address.zipcode' => ['required_with:address.line_1', 'nullable', 'string', 'regex:/^[0-9]{6}$/'],
            'address.landmark' => ['nullable', 'string', 'max:255'],

            // Contact Validation
            'contact' => ['nullable', 'array'],
            'contact.contact_type_id' => ['required_with:contact.name', 'nullable', 'exists:mm_contact_types,id'],
            'contact.name' => ['nullable', 'string', 'max:255'],
            'contact.email' => ['nullable', 'email', 'max:255'],
            'contact.mobile' => ['required_with:contact.name', 'nullable', 'string', 'regex:/^[0-9]{10}$/'],
