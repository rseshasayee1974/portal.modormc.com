...
namespace TraceReplay\Facades {
    ...
    class TraceReplay {
         ...
         * @static
         */
        public static function start($name, $tags = [], $type = 'http', $forceSample = false)
        {
            /** @var \TraceReplay\TraceReplayManager $instance */
            return $instance->start($name, $tags, $type, $forceSample);
        }

        /**
         * @static
         */
        public static function step($label, $callback, $extra = [])
        {
            /** @var \TraceReplay\TraceReplayManager $instance */
            return $instance->step($label, $callback, $extra);
        }
         ...
         * @static
         */
        public static function measure($label, $callback, $extra = [])
        {
            /** @var \TraceReplay\TraceReplayManager $instance */
            return $instance->measure($label, $callback, $extra);
        }
         ...
         * @static
         */
        public static function checkpoint($label, $state = [])
        {
            /** @var \TraceReplay\TraceReplayManager $instance */
            return $instance->checkpoint($label, $state);
        }
         ...
         * @static
         */
        public static function captureResponseOnLastStep($responsePayload, $httpStatus = 200)
        {
            /** @var \TraceReplay\TraceReplayManager $instance */
            return $instance->captureResponseOnLastStep($responsePayload, $httpStatus);
        }
         ...
         * @static
         */
        public static function end($status = 'success', $exception = null)
        {
            /** @var \TraceReplay\TraceReplayManager $instance */
            return $instance->end($status, $exception);
        }

        /**
         * @static
         */
        public static function setWorkspaceId($id)
        {
            /** @var \TraceReplay\TraceReplayManager $instance */
            return $instance->setWorkspaceId($id);
        }
        ...
        {
            /** @var \TraceReplay\TraceReplayManager $instance */
            return $instance->setProjectId($id);
        }

        /**
         * @static
         */
        public static function setTraceParent($traceParent)
        {
            /** @var \TraceReplay\TraceReplayManager $instance */
            return $instance->setTraceParent($traceParent);
        }

        /**
         * @static
         */
        public static function recordEvent($event)
        {
            /** @var \TraceReplay\TraceReplayManager $instance */
            return $instance->recordEvent($event);
        }
        ...
        {
            /** @var \TraceReplay\TraceReplayManager $instance */
            return $instance->getCurrentTrace();
        }
        ...
        {
            /** @var \TraceReplay\Testing\TraceReplayFake $instance */
         ...
         * @static
         */
        public static function assertTraceStarted($name)
        {
            /** @var \TraceReplay\Testing\TraceReplayFake $instance */
            return $instance->assertTraceStarted($name);
        }

        /**
         * @static
         */
        public static function assertStepRecorded($label)
        {
            /** @var \TraceReplay\Testing\TraceReplayFake $instance */
            return $instance->assertStepRecorded($label);
        }

        /**
         * @static
         */
        public static function assertStepCount($count, $traceName = null)
        {
            /** @var \TraceReplay\Testing\TraceReplayFake $instance */
            return $instance->assertStepCount($count, $traceName);
        }

        /**
         * @static
         */
        public static function assertTraceEnded($status = 'success')
        {
            /** @var \TraceReplay\Testing\TraceReplayFake $instance */
            return $instance->assertTraceEnded($status);
        }

        /**
         * @static
         */
        public static function assertCheckpointRecorded($label)
        {
            /** @var \TraceReplay\Testing\TraceReplayFake $instance */
            return $instance->assertCheckpointRecorded($label);
        }

        /**
         * @static
         */
        public static function assertNoTraceStarted()
        {
            /** @var \TraceReplay\Testing\TraceReplayFake $instance */
            return $instance->assertNoTraceStarted();
        }

        /**
         * @static
         */
        public static function assertTraceCount($count)
        {
            /** @var \TraceReplay\Testing\TraceReplayFake $instance */
            return $instance->assertTraceCount($count);
        }
...
namespace  {
    ...
    class TraceReplay extends \TraceReplay\Facades\TraceReplay {}
}
