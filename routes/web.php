...
Route::middleware([
  ...
  Route::get('default-accounts', [\App\Http\Controllers\AccountDefaultSettingController::class, 'index'])->name('settings.account-defaults');
    ...
    Route::prefix('quality')->group(function () {
        ...
        Route::prefix('configuration')->group(function () {
            ...
            Route::post('units/{unit}/toggle', [\App\Http\Controllers\QC\QCUnitController::class, 'toggleActive'])->name('quality.config.units.toggle');
  ...
  Route::prefix('reports')->group(function () {
    ...
    Route::prefix('finance')->group(function () {
        ...
        Route::get('batches/{batch}/print-ewaybill', [\App\Http\Controllers\EwayBillController::class, 'printForBatch'])->name('batches.print-ewaybill');
